...
APPNAME = "ThunderCore"
else ifeq ($(CHAIN),energi)
APP_LOAD_PARAMS += --path "44'/9797'"
DEFINES += CHAINID_UPCASE=\"ENERGI\" CHAINID_COINNAME=\"NRG\" CHAIN_KIND=CHAIN_KIND_ENERGI CHAIN_ID=49797
APPNAME = "Energi"
else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported CHAIN - use ethereum, ethereum_classic, expanse, poa, artis_sigma1, artis_tau1, rsk, rsk_testnet, ubiq, wanchain, kusd, musicoin, pirl, akroma, atheios, callisto, ethersocial, ellaism, ether1, ethergem, gochain, mix, reosc, hpb, tomochain, tobalaba, dexon, volta, ewc, webchain, thundercore, energi)
endif
endif
